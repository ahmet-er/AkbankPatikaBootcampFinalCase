...
public record GetUserByParameterQuery(string UserName, string FirstName, string LastName, string Email, string Role) : IRequest<ApiResponse<List<UserResponse>>>; 
#endregion